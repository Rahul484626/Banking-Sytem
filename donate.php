...
<?php
    ...
    if($result){
               echo "<script> alert('Hurray! You have Donated');
...
?>
        ...
        <h2 class="text-center pt-4" style="color : black;">Donate</h2>
        ...
        <div class="screen-body-item">
          <form class="app-form" method="post">
            ...
            <div class="app-form-group button">
              <input class="app-form-button" type="submit" value="Donate" name="submit"></input>
...
<footer class="text-center mt-5 py-2">
            <p>&copy 2021. Made by <b>Rahul</b> <br>All Rights reserved</p>
</footer>
