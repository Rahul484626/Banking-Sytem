...
<html lang="en">
  ...
  ?>
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  <div class="col-md act">
                    ...
                    <br>
                    <a href="donate.php"><button style="background-color : #2785C4;">Donate</button></a>
                  </div>
                  <div class="col-md act">
      ...
      <footer class="text-center mt-2 py-8">
        <p class="foot">&copy 2021. Made by <b>Rahul</b> <br> All copyrights reserved</p>
      </footer>
